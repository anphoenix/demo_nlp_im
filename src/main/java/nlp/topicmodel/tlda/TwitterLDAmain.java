...
public class TwitterLDAmain {
	...
	public static void main(String args[]) throws Exception {
		...
		String filelist = base + "tlda_parameter/filelist.txt";
		String dataDir = base + "originaldocs/";
		String outputDir = base + "output/tlda/";
		String modelParas = base + "tlda_parameter/parameters.txt";
		...
		int outputBackgroundwordCnt = 100;
